...
public class DbInitilizer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		userRepository.save(new User(1L, "John Doe", "skaradkar57@gmail.com", "assd12345", true, true, Roles.ADMIN, Gender.M));
		userRepository.save(new User(2L, "Jane Doe", "ak@gmai.com", "assd12345", true, true, Roles.USER, Gender.F));
